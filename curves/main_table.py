...
def main() -> None:
    ...
    parser.add_argument("--png", type=Path, default=ROOT / "curves" / "summary_table.png")
    parser.add_argument("--pdf", type=Path, default=ROOT / "curves" / "summary_table.pdf")
    parser.add_argument("--csv", type=Path, default=ROOT / "curves" / "summary_table.csv")
    parser.add_argument("--xlsx", type=Path, default=ROOT / "curves" / "summary_table.xlsx")
    parser.add_argument("--tex", type=Path, default=ROOT / "curves" / "summary_table.tex")
